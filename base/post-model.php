...
abstract class PostModel {
    ...
    public function __get( $name ) {
        ...
        throw new \Exception( esc_html( sprintf( __( 'Undefined property %s', 'poptics' ), $name ) ) );
    }
    ...
    public function __set( $key, $value ) {
        if ( !isset( $this->data[$key] ) ) {
            // translators: %s is the name of the property
            throw new \Exception( esc_html( sprintf( __( 'Undefined property %s', 'poptics' ), $key ) ) );
        }
